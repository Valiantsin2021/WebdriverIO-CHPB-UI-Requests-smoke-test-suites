...
const { bannersLinks, title } = require('../../utils/constants.historia')
describe(`Should open Historia page and check`, async function () {
  ...
  it(`Cookies modal is displayed`, async function () {
    ...
    await expect(HistoriaPage.cookiesModal).toExist()
    await HistoriaPage.cookiesAcceptBtn.waitForDisplayed()
  })
  it(`Historia page header is ${clubHeader}`, async function () {
    console.info(`Check Historia page header is ${clubHeader}`)
    await HistoriaPage.acceptCookies()
    const headerText = await HistoriaPage.header.waitAndGetText()
    expectChai(headerText).to.eq(clubHeader)
  })
  it(`Historia page title is displayed`, async function () {
    console.info(`Historia page title is displayed`)
    const title = await HistoriaPage.title
    await expect(title).toBeDisplayed()
  })
  it(`Historia page title is ${title}`, async function () {
    console.info(`Check Historia page title is '${title}'`)
    const pageTitle = await HistoriaPage.title.waitAndGetText()
  ...
  it(`Home page club logotype is displayed`, async function () {
    ...
    const logotype = await HistoriaPage.logotype
  ...
  it(`Historia Page main image content is displayed`, async function () {
    console.info(`Historia Page main image content is displayed`)
    await expect(HistoriaPage.mainImg).toExist()
    await expect(HistoriaPage.mainImg).toBeDisplayed()
  })
  it(`Top menu elements are displayed`, async function () {
    console.info(`Top menu elements are displayed`)
    await HistoriaPage.header.waitForDisplayed()
    const topMenu = await HistoriaPage.topMenuDropdownElements
  ...
  it(`Top menu number of elements`, async function () {
    ...
    const topMenuLength = await HistoriaPage.topMenuDropdownElements
  ...
  it(`Top menu inner elements are displayed`, async function () {
    ...
    await showInnerMenu(HistoriaPage.topMenuContainer)
    const topMenuInner = await HistoriaPage.topMenuInnerElements
  ...
  it(`Top menu number of inner elements`, async function () {
    ...
    const topMenuInnerLength = await HistoriaPage.topMenuInnerElements
  ...
  it(`Top social links are displayed`, async function () {
    ...
    await hideInnerMenu(HistoriaPage.topMenuContainer)
    await HistoriaPage.header.waitForDisplayed()
    const socialMedia = await HistoriaPage.socialMediaLinksTop
  ...
  it(`Top social links number of elements`, async function () {
    ...
    const socialMediaLength = await HistoriaPage.socialMediaLinksTop
  ...
  it(`Top social links href attribute against '${socialMediaLinks.join(
    ...
    const socialLinks = await HistoriaPage.socialMediaLinksTop.map(el =>
  ...
  it(`Image banners on the Home page are displayed`, async function () {
    ...
    const banners = await HistoriaPage.imageBanners
  ...
  it(`Image banners on the Home page href attribute against '${bannersLinks.join(
    ...
    const bannerHrefs = await HistoriaPage.bannersLinks.map(el =>
      el.getAttribute('href')
    )
  ...
  footerLinksText.forEach((el, i) => {
    it(`Footer links text corresponds '${el}'`, async function () {
      ...
      const footerLinks = await HistoriaPage.footerLinks.slice(0, -1)
  ...
  sponsorCategoriesText.forEach((el, i) => {
    it(`Sponsor categories each element's text corresponds '${el}'`, async function () {
      ...
      const sponsorCategories = await HistoriaPage.sponsorsCategories
  ...
  it(`Sponsors list number of elements is ${sponsorsNumber}`, async function () {
    ...
    const sponsors = await HistoriaPage.sponsorsList
